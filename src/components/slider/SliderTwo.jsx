  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${process.env.PUBLIC_URL + "img/banner/bg-1.jpg"
            })`,
        }}
      >
            ...
            <div className="col-lg-12">
              <div className="hb-typo ">
                <h1 className="font-alt">
                  Hello,
                  <br /> I'm M.Umar Shahzad, a <br /> Junior {" "}
                  <TextLoop>
                    <span className="loop-text">React JS Developer</span>
                    <span className="loop-text">Node JS Developer</span>
                  </TextLoop>{" "}
                </h1>
